  ...
  return (
    <div id="hero" className="relative min-h-[100dvh] flex items-center justify-center">
      ...
      >
        ...
        >
          Software Developer's Journey in Progress
        </motion.p>
        ...
        >
          {[
            { href: "https://github.com/devpatel21-03", icon: "simple-icons:github", label: "GitHub", color: "hover:text-gray-900 dark:hover:text-white" },
            { href: "https://www.linkedin.com/in/dev-patel-965073257", icon: "skill-icons:linkedin", label: "LinkedIn", color: "hover:text-blue-600" }
          ].map((link) => (
